        ...
        data.map((item, index) => (
          <div key={index}>
            <div className='w-full flex justify-between'>
              <span className='text-3xl flex items-center'>{item.title}<a href='https://toshare.vercel.app' target='_blank' className='text-blue-300 hover:scale-110 cursor-pointer '><FaLink /></a></span>
            ...
            <div className='w-full flex '>
              <Image
                        ...
                        />
                            <div className='w-[70%] text-center'>{item.abstract}</div>
